...
let decoders_suite =
  ...
  [ "list string" >::
    decoder_test
      ~decoder:(list string)
      ~input:(CBOR.Simple.encode (`Array [`Text "hello"; `Text "world"]))
      ~expected:["hello"; "world"]
  ; "field_opt present" >::
    decoder_test
      ~decoder:(field_opt "optional" string)
      ~input:(CBOR.Simple.encode (`Map [(`Text "optional", `Text "hello")]))
      ~expected:(Some "hello")
  ; "field_opt missing" >::
    decoder_test
      ~decoder:(field_opt "optional" string)
      ~input:(CBOR.Simple.encode (`Map [(`Text "missing", `Text "hello")]))
      ~expected:None
